...
const RATE_LIMIT_CONFIG = {
  MAX_REQUESTS_PER_SESSION: parseInt(process.env.MAX_REQUESTS_PER_SESSION || "100000"),
  MAX_REQUESTS_PER_IP_PER_MINUTE: parseInt(process.env.MAX_REQUESTS_PER_IP_PER_MINUTE || "20000"),
  MAX_REQUESTS_PER_IP_PER_HOUR: parseInt(process.env.MAX_REQUESTS_PER_IP_PER_HOUR || "200000"),
  MAX_MESSAGE_LENGTH: parseInt(process.env.MAX_MESSAGE_LENGTH || "2000"),
  GLOBAL_MAX_REQUESTS_PER_MINUTE: parseInt(process.env.GLOBAL_MAX_REQUESTS_PER_MINUTE || "200000"),
};
